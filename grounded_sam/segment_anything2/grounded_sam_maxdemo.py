...
if __name__ == "__main__":
    ...
    # transformed_boxes: tensor([[457.8209,  32.7092, 732.1819, 548.9686]], device='cuda:0')
    ...
    img[~mask] = 0
    box_seg =  boxes_filt[0]
    img = img[int(box_seg[1]):int(box_seg[3]), int(box_seg[0]):int(box_seg[2])]
    Image.fromarray(img).save(os.path.join(output_dir, 'seg.png'))
